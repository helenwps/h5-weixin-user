        ...
        <div id="slider" class="mui-slider mui-fullscreen">
            <div id="sliderSegmentedControl" class="mui-scroll-wrapper mui-slider-indicator mui-segmented-control mui-segmented-control-inverted" v-if="pageObj.type==3">
                <div class="mui-scroll">
                    <a class="mui-control-item mui-active"   :index="1" @click="tab(1)">   
                                                全部
                    </a>
                    <a class="mui-control-item"   :index="2" @click="tab(2)">
                       	待付款
                    </a>
                    <a class="mui-control-item"   :index="3" @click="tab(3)">
                                                待交付
                    </a>
 					<a class="mui-control-item"  :index="4" @click="tab(4)">
                                                待验收
                    </a>
                    <a class="mui-control-item" :index="7" @click="tab(7)">
                                                待评价
                    </a>
                </div>
            </div>
		...
		mounted(){
		 ...
		 methods: {
        	...
        	jump:function(orderNo,index){
        		...
        		var params,path;
//      		var item={
//	                "orderNo": "1118480138261541919",
//	                "serverNickname": "s测试123",
//	                "lawyerCompany": "s乐",
//	                "amount": 10000,
//	                "logo":"http://192.168.10.217:1080/upload/user/3853/0bec6d22d2564ed19cd654db73fc60fa.png",
//	                "goodsName": "test-test",
//	                "orderStatus": 1,
//	                "createTime": "2018-01-26 11:36:11",
//	                 "goodsUrl": "http://192.168.10.217:1080/upload/config/goods/dcc939e73afe4f67bd42330d18fdee41.jpg"  
//	            }
